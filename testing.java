...
public class testing{
	...
	//  Map<Double, Map<Double, LocNot>> the_new_nots=LocNotManager.load("output.txt");
	  
	  
	//  LocNotManager.print(LocNotManager.getAllNots(the_new_nots));
	  
	 // System.out.println("after reading: ");
		
	//  System.out.println("****************************************************");
	  
	 // LocNotManager.save("theone.txt", the_new_nots);
